...
const en: Translations = {
  ...
  about: {
    ...
    description: [
      'I\'m Julius, a passionate UX Designer with a keen eye for detail and a deep understanding of user behavior. My design philosophy centers around empathy, research, and iterative thinking.',
  ...
  footer: {
    copyright: '© 2026 Julius. All rights reserved.',
...
const de: Translations = {
  ...
  about: {
    ...
    description: [
      'Ich bin Julius, ein leidenschaftlicher UX Designer mit einem Auge fürs Detail und einem tiefen Verständnis für Nutzerverhalten. Meine Designphilosophie basiert auf Empathie, Forschung und iterativem Denken.',
  ...
  footer: {
    copyright: '© 2026 Julius. Alle Rechte vorbehalten.',
